...
def main(
    ...
    print("DEVICE", local_rank, global_rank, torch.cuda.current_device(), torch.cuda.device_count(), node_id)
    ...
    prompts = [
        ...
        "It is the year 2022, what is the sum of 5 and 9?",
        "It is the year 2022, the sum of 6 and 9 is"
    ]
